...
extern EIF_TYPED_VALUE F877_8610(EIF_REFERENCE);
...
RTOID (F877_8610)
EIF_TYPED_VALUE F877_8610 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 876, Current, 0, 0, 14288);
	RTSA(Dtype(Current));
	RTSC;
