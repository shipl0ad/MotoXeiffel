...
extern EIF_TYPED_VALUE F944_10522(EIF_REFERENCE);
extern void F944_10523(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F944_10524(EIF_REFERENCE);
extern void F944_10525(EIF_REFERENCE);
extern void F944_10526(EIF_REFERENCE);
...
EIF_TYPED_VALUE F944_10522 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 943, Current, 0, 0, 16274);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(943, Current, 16274);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(4944, 864))(Current)).it_i4);
...
void F944_10523 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define arg1 arg1x.it_b
	...
	RTEAA(l_feature_name, 943, Current, 0, 1, 16275);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(943, Current, 16275);
	RTIV(Current, RTAL);
	RTHOOK(1);
	if (arg1) {
		RTHOOK(2);
	...
	if (RTAL & CK_ENSURE) {
		...
		if ((EIF_BOOLEAN) !tb2) {
			tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(8234, dtype))(Current)).it_b);
			tb1 = (tb2 == arg1);
		}
		if (tb1) {
			RTCK;
...
void F944_10524 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 943, Current, 1, 0, 16276);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(943, Current, 16276);
	RTIV(Current, RTAL);
	RTHOOK(1);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(6468, dtype))(Current);
	RTHOOK(2);
	RTDBGAL(Current, 1, 0x10000000, 1, 0); /* loc1 */
	loc1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(4943, 864))(Current)).it_i4);
	RTHOOK(3);
	ui4_1 = loc1;
...
void F944_10525 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 943, Current, 0, 0, 16277);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(943, Current, 16277);
	RTIV(Current, RTAL);
...
body:;
	...
	RTHOOK(3);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(4945, 864))(Current);
	if (RTAL & CK_ENSURE) {
		RTHOOK(4);
...
void F944_10526 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 943, Current, 1, 0, 16278);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(943, Current, 16278);
	RTIV(Current, RTAL);
	RTHOOK(1);
