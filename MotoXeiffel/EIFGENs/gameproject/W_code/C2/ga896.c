...
extern void F896_9357(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
...
void F896_9357 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define uu1_4 uu1_4x.it_n1
	...
	RTEAA(l_feature_name, 895, Current, 6, 3, 15057);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(895, Current, 15057);
...
body:;
	...
	loc6 = *(EIF_INTEGER_32 *)(Current + RTWA(7235, dtype));
