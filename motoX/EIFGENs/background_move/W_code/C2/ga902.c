...
extern void F902_9413(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F902_9414(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F902_10331(EIF_REFERENCE, int);
...
void F902_9413 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 901, Current, 0, 3, 15123);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(901, Current, 15123);
	RTCC(arg1, 901, l_feature_name, 1, eif_new_type(923, 0x01), 0x01);
	RTIV(Current, RTAL);
	if ((RTAL & CK_REQUIRE) || RTAC) {
		RTHOOK(1);
		RTCT("not_indexed", EX_PRE);
		tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(7653, "is_indexed", arg1))(arg1)).it_b);
...
body:;
	...
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(7731, "bytes_per_pixel", arg1))(arg1)).it_i4);
	*(EIF_INTEGER_32 *)(Current + RTWA(7289, dtype)) = (EIF_INTEGER_32) ti4_1;
	RTHOOK(3);
	RTDBGAA(Current, dtype, 7285, 0xF800039B, 0); /* pixel_format */
	RTAR(Current, arg1);
	*(EIF_REFERENCE *)(Current + RTWA(7285, dtype)) = (EIF_REFERENCE) RTCCL(arg1);
	RTHOOK(4);
	...
	*(EIF_INTEGER_32 *)(Current + RTWA(7283, dtype)) = (EIF_INTEGER_32) arg3;
	RTHOOK(6);
	RTDBGAA(Current, dtype, 7284, 0x10000000, 1); /* pitch */
	ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(7289, dtype));
	*(EIF_INTEGER_32 *)(Current + RTWA(7284, dtype)) = (EIF_INTEGER_32) (EIF_INTEGER_32) (arg2 * ti4_1);
	RTHOOK(7);
...
EIF_TYPED_VALUE F902_9414 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 901, Current, 0, 2, 15124);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	if ((RTAL & CK_REQUIRE) || RTAC) {
		...
		ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(7282, dtype));
...
body:;
	...
	ui4_1 = arg1;
	ui4_2 = arg2;
	Result = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWF(7291, 900))(Current, ui4_1x, ui4_2x)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(5);
	RTDBGLE;
...
void F902_10331 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 901, Current, 0, 10330);
	RTSA(dtype);
	RTME(dtype, 0);
