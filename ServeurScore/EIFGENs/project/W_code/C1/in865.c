...
extern EIF_TYPED_VALUE F865_7075(EIF_REFERENCE);extern EIF_BOOLEAN en_ipv6_available();

extern EIF_TYPED_VALUE F865_7076(EIF_REFERENCE);extern EIF_BOOLEAN en_get_prefer_ipv4();

extern void F865_7077(EIF_REFERENCE, EIF_TYPED_VALUE);extern void en_set_prefer_ipv4(EIF_BOOLEAN);

extern void F865_7516(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F865_7075 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 864, Current, 0, 0, 12681);
	RTSA(Dtype(Current));
	RTSC;
...
void F865_7516 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 864, Current, 0, 7515);
	RTSA(dtype);
	RTME(dtype, 0);
	RTIT("exclusive", Current);
	tb1 = '\01';
	tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(4963, dtype))(Current)).it_b);
	if (tb2) {
