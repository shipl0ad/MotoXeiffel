...
extern EIF_TYPED_VALUE F894_9407(EIF_REFERENCE);
...
RTOID (F894_9407)
EIF_TYPED_VALUE F894_9407 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 893, Current, 0, 0, 15109);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(893, Current, 15109);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
