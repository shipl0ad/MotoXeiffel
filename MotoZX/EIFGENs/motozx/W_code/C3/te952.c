...
extern EIF_TYPED_VALUE F952_10607(EIF_REFERENCE);
...
RTOID (F952_10607)
EIF_TYPED_VALUE F952_10607 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 951, Current, 0, 0, 16302);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(951, Current, 16302);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
