...
static const struct desc_info desc_963[] = {
	...
	{EIF_NON_GENERIC(0x0167 /*179*/), 16383, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x0185 /*194*/), 16384, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x0191 /*200*/), 16385, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x01A9 /*212*/), 16386, 0xFFFFFFFF},
};
void Init963(void)
{
	IDSC(desc_963, 0, 962);
	IDSC(desc_963 + 1, 1, 962);
	IDSC(desc_963 + 32, 449, 962);
}
