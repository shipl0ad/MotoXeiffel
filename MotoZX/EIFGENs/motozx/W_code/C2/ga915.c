...
extern void F915_9596(EIF_REFERENCE);
extern void F915_9597(EIF_REFERENCE);
extern void F915_9598(EIF_REFERENCE, EIF_TYPED_VALUE);
...
/* {GAME_ENGINE}.make */
void F915_9596 (EIF_REFERENCE Current)
{
	GTCX
...
#define ub3 ub3x.it_b
	...
	RTEAA(l_feature_name, 914, Current, 0, 0, 15289);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
#define uu1_3 uu1_3x.it_n1
	...
	RTEAA(l_feature_name, 914, Current, 2, 0, 15290);
	RTSA(Dtype(Current));
	RTSC;
...
/* {GAME_ENGINE}.on_quit */
void F915_9598 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 914, Current, 0, 1, 15291);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(914, Current, 15291);
	RTIV(Current, RTAL);
	RTHOOK(1);
