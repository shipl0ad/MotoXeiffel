...
extern void F867_7084(EIF_REFERENCE, EIF_TYPED_VALUE);extern void en_local_host_name(EIF_POINTER);
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 866, Current, 1, 0, 12685);
	RTSA(Dtype(Current));
	RTSC;
	...
	up1 = tp1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(4968, Dtype(Current)))(Current, up1x);
	RTHOOK(3);
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 866, Current, 0, 0, 12687);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
...
void F867_7084 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
{
	GTCX
	RTOTS (7082,F867_7082)
	RTOTS (7083,F867_7083)
}
