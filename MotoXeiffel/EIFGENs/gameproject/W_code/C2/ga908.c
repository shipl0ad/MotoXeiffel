...
extern void F908_9476(EIF_REFERENCE, EIF_TYPED_VALUE);
...
extern EIF_TYPED_VALUE F908_9489(EIF_REFERENCE);
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 907, Current, 1, 1, 15183);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAA(Current, dtype, 7335, 0x10000000, 1); /* index */
	*(EIF_INTEGER_32 *)(Current + RTWA(7335, dtype)) = (EIF_INTEGER_32) arg1;
	RTHOOK(2);
	...
	ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(7335, dtype));
	ui4_1 = ti4_1;
...
void F908_9476 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTHOOK(1);
	RTDBGAA(Current, dtype, 7335, 0x10000000, 1); /* index */
	*(EIF_INTEGER_32 *)(Current + RTWA(7335, dtype)) = (EIF_INTEGER_32) ((EIF_INTEGER_32) -1L);
	RTHOOK(2);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(1057, dtype))(Current);
	RTHOOK(3);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(6432, dtype))(Current);
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 907, Current, 1, 0, 15185);
	RTSA(Dtype(Current));
	RTSC;
...
#define uu4_1 uu4_1x.it_n4
	...
	RTEAA(l_feature_name, 907, Current, 2, 0, 15187);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
EIF_TYPED_VALUE F908_9482 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
	r.it_i4 = *(EIF_INTEGER_32 *)(Current + RTWA(7335,Dtype(Current)));
	return r;
}
...
#define uu4_1 uu4_1x.it_n4
	...
	tu4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(7340, Dtype(Current)))(Current)).it_n4);
	RTNHOOK(1,1);
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 907, Current, 1, 0, 15180);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
EIF_TYPED_VALUE F908_9488 (EIF_REFERENCE Current)
{
	...
	RTEAA(l_feature_name, 907, Current, 0, 0, 15181);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
EIF_TYPED_VALUE F908_9489 (EIF_REFERENCE Current)
{
	GTCX
