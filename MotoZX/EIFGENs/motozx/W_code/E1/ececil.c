...
void A879_49 (EIF_REFERENCE Current, EIF_INTEGER_32 arg1)
{
	EIF_TYPED_VALUE u [1];
	GTCX
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTVF(6523, "thr_main", Current))(Current, ((u [0].type = SK_INT32), (u [0].it_i4 = arg1), u [0]));
}
...
{
	GTCX
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(7639, "close", open [1].it_r))(open [1].it_r);
}
...
{
	GTCX
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(7638, "set_thread_safe", open [1].it_r))(open [1].it_r);
}
...
{
	GTCX
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTVF(7634, "update_playing", open [1].it_r))(open [1].it_r);
}
