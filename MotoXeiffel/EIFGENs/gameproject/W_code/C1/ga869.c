...
extern EIF_TYPED_VALUE F869_8490(EIF_REFERENCE);
...
EIF_TYPED_VALUE F869_8489 (EIF_REFERENCE Current)
{
	...
	Result = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(6396, 867))(Current)).it_b);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
...
EIF_TYPED_VALUE F869_8490 (EIF_REFERENCE Current)
{
	GTCX
