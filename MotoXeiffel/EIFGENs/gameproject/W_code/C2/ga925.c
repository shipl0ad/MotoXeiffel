...
extern void F925_10087(EIF_REFERENCE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F925_10088(EIF_REFERENCE);
extern EIF_TYPED_VALUE F925_10089(EIF_REFERENCE);
extern EIF_TYPED_VALUE F925_10090(EIF_REFERENCE);
...
void F925_10087 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 924, Current, 0, 1, 15792);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
body:;
	...
	RTHOOK(5);
	RTDBGAA(Current, dtype, 7889, 0x10000000, 1); /* index */
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 924, Current, 2, 0, 15794);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(924, Current, 15794);
	RTIV(Current, RTAL);
	RTHOOK(1);
...
EIF_TYPED_VALUE F925_10090 (EIF_REFERENCE Current)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 924, Current, 0, 0, 15795);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(924, Current, 15795);
	RTIV(Current, RTAL);
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x40000000, 1,0); /* Result */
	ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(7889, Dtype(Current)));
	ui4_1 = ti4_1;
