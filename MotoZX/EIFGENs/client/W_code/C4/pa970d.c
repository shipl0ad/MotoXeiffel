...
static const EIF_TYPE_INDEX egt_13_970 [] = {0xFF01,151,0xFFFF};
...
static const struct desc_info desc_970[] = {
	...
	{EIF_NON_GENERIC(0x019D /*206*/), 16527, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x0173 /*185*/), 16528, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x0173 /*185*/), 16529, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x017F /*191*/), 16530, 0xFFFFFFFF},
	{EIF_GENERIC(NULL), 16531, 0xFFFFFFFF},
	{EIF_GENERIC(egt_13_970), 16534, 0},
};
void Init970(void)
{
	IDSC(desc_970, 0, 969);
