...
extern EIF_TYPED_VALUE F880_8669(EIF_REFERENCE);
...
RTOID (F880_8669)
EIF_TYPED_VALUE F880_8669 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 879, Current, 0, 0, 14349);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(879, Current, 14349);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
