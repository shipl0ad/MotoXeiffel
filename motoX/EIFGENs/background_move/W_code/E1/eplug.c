...
void egc_init_plug (void)
{
	...
	egc_system_name = "background_move";
	egc_system_location = "C:\\Users\\DANKCPU\\Desktop\\motox\\MotoXeiffel\\motoX\\EIFGENs\\background_move\\W_code";
	egc_compiler_tag = 38;
	egc_project_version = 1459789276;
