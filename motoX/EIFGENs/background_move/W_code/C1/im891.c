...
extern EIF_TYPED_VALUE F891_9388(EIF_REFERENCE);
...
RTOID (F891_9388)
EIF_TYPED_VALUE F891_9388 (EIF_REFERENCE Current)
{
	GTCX
...
#define Result RTOTRR
	...
	RTEAA(l_feature_name, 890, Current, 0, 0, 15087);
	RTSA(Dtype(Current));
	RTSC;
	RTME(Dtype(Current), 0);
	RTGC;
	RTDBGEAA(890, Current, 15087);
	RTIV(Current, RTAL);
	RTOTP;
	RTHOOK(1);
