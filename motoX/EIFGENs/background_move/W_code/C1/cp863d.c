...
static const struct desc_info desc_863[] = {
	...
	{EIF_NON_GENERIC(0x0167 /*179*/), 12664, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x0185 /*194*/), 12665, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x0191 /*200*/), 12666, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x01A9 /*212*/), 12667, 0xFFFFFFFF},
	...
	{EIF_NON_GENERIC(0x0179 /*188*/), 12674, 0xFFFFFFFF},
};
void Init863(void)
{
	IDSC(desc_863, 0, 862);
	IDSC(desc_863 + 1, 1, 862);
	IDSC(desc_863 + 32, 408, 862);
}
