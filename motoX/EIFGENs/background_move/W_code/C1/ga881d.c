...
static const EIF_TYPE_INDEX egt_15_881 [] = {0xFF01,925,0xFFFF};
...
static const struct desc_info desc_881[] = {
	...
	{EIF_GENERIC(egt_14_881), 14191, 0xFFFFFFFF},
	...
	{EIF_GENERIC(NULL), 0x00, 0xFFFFFFFF},
	{EIF_NON_GENERIC(0x017F /*191*/), 14746, 10},
...
void Init881(void)
{
	...
	IDSC(desc_881 + 32, 403, 880);
	IDSC(desc_881 + 42, 378, 880);
	IDSC(desc_881 + 46, 404, 880);
}
