...
#define uu4_1 uu4_1x.it_n4
	...
	RTHOOK(1);
	uu4_1 = arg1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(6403, dtype))(Current, uu4_1x);
	RTHOOK(2);
	RTDBGAA(Current, dtype, 6402, 0x38000000, 1); /* state */
	*(EIF_NATURAL_32 *)(Current + RTWA(6402, dtype)) = (EIF_NATURAL_32) arg2;
	RTHOOK(3);
	RTDBGAA(Current, dtype, 6395, 0x10000000, 1); /* x */
	*(EIF_INTEGER_32 *)(Current + RTWA(6395, dtype)) = (EIF_INTEGER_32) arg3;
	RTHOOK(4);
	RTDBGAA(Current, dtype, 6396, 0x10000000, 1); /* y */
	*(EIF_INTEGER_32 *)(Current + RTWA(6396, dtype)) = (EIF_INTEGER_32) arg4;
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(5);
	RTDBGLE;
