...
extern void F909_9512(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern EIF_TYPED_VALUE F909_9513(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
extern void F909_10462(EIF_REFERENCE, int);
...
void F909_9512 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x, EIF_TYPED_VALUE arg3x)
{
	GTCX
...
#define ui4_1 ui4_1x.it_i4
	...
	RTEAA(l_feature_name, 908, Current, 0, 3, 15202);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	...
	if ((RTAL & CK_REQUIRE) || RTAC) {
		...
		tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(7760, "is_indexed", arg1))(arg1)).it_b);
...
body:;
	...
	ti4_1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTVF(7838, "bytes_per_pixel", arg1))(arg1)).it_i4);
	*(EIF_INTEGER_32 *)(Current + RTWA(7385, dtype)) = (EIF_INTEGER_32) ti4_1;
	RTHOOK(3);
	RTDBGAA(Current, dtype, 7381, 0xF80003A3, 0); /* pixel_format */
	RTAR(Current, arg1);
	*(EIF_REFERENCE *)(Current + RTWA(7381, dtype)) = (EIF_REFERENCE) RTCCL(arg1);
	RTHOOK(4);
	RTDBGAA(Current, dtype, 7378, 0x10000000, 1); /* width */
	*(EIF_INTEGER_32 *)(Current + RTWA(7378, dtype)) = (EIF_INTEGER_32) arg2;
	RTHOOK(5);
	RTDBGAA(Current, dtype, 7379, 0x10000000, 1); /* height */
	*(EIF_INTEGER_32 *)(Current + RTWA(7379, dtype)) = (EIF_INTEGER_32) arg3;
	RTHOOK(6);
	RTDBGAA(Current, dtype, 7380, 0x10000000, 1); /* pitch */
	ti4_1 = *(EIF_INTEGER_32 *)(Current + RTWA(7385, dtype));
	*(EIF_INTEGER_32 *)(Current + RTWA(7380, dtype)) = (EIF_INTEGER_32) (EIF_INTEGER_32) (arg2 * ti4_1);
	RTHOOK(7);
	...
	*(EIF_REFERENCE *)(Current + RTWA(7384, dtype)) = (EIF_REFERENCE) RTCCL(tr1);
	...
	RTNHOOK(8,2);
	tb1 = !tp1;
	*(EIF_BOOLEAN *)(Current + RTWA(7382, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) !tb1;
	RTHOOK(9);
...
EIF_TYPED_VALUE F909_9513 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ui4_2 ui4_2x.it_i4
	...
	RTEAA(l_feature_name, 908, Current, 0, 2, 15203);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
body:;
	...
	ui4_1 = arg1;
	ui4_2 = arg2;
	Result = ((up1x = (FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE)) RTWF(7387, 907))(Current, ui4_1x, ui4_2x)), (((up1x.type & SK_HEAD) == SK_REF)? (EIF_REFERENCE) 0: (up1x.it_r = RTBU(up1x))), (up1x.type = SK_POINTER), up1x.it_r);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(5);
	RTDBGLE;
...
void F909_10462 (EIF_REFERENCE Current, int where)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 908, Current, 0, 10461);
	RTSA(dtype);
	RTME(dtype, 0);
	...
	tb2 = !tp1;
	if (tb2) {
		tb2 = *(EIF_BOOLEAN *)(Current + RTWA(7382, dtype));
		tb1 = (EIF_BOOLEAN) !tb2;
	}
	if (tb1) {
		RTCK;
