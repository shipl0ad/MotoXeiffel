...
extern EIF_TYPED_VALUE F885_8662(EIF_REFERENCE);
extern void F885_10521(EIF_REFERENCE, int);
...
EIF_TYPED_VALUE F885_8662 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_INT32;
...
void F885_10521 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 884, Current, 0, 10520);
	RTSA(dtype);
	RTME(dtype, 0);
