...
static const EIF_TYPE_INDEX egt_13_900 [] = {0xFF01,901,0xFFFF};
static const EIF_TYPE_INDEX egt_14_900 [] = {0xFF01,901,0xFFFF};
...
static const struct desc_info desc_900[] = {
	...
	{EIF_NON_GENERIC(0x017F /*191*/), 15132, 0xFFFFFFFF},
	{EIF_GENERIC(egt_13_900), 0x00, 0xFFFFFFFF},
...
void Init900(void)
{
	...
	IDSC(desc_900 + 32, 374, 899);
	IDSC(desc_900 + 35, 406, 899);
	IDSC(desc_900 + 37, 369, 899);
}
