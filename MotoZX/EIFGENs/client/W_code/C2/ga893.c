...
extern void F893_8771(EIF_REFERENCE);
extern void F893_8772(EIF_REFERENCE, EIF_TYPED_VALUE, EIF_TYPED_VALUE);
...
extern EIF_TYPED_VALUE F893_8776(EIF_REFERENCE);
...
void F893_8771 (EIF_REFERENCE Current)
{
	GTCX
	...
	RTEAA(l_feature_name, 892, Current, 0, 0, 14454);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(892, Current, 14454);
	RTIV(Current, RTAL);
	RTHOOK(1);
	(FUNCTION_CAST(void, (EIF_REFERENCE)) RTWF(5068, 868))(Current);
	RTHOOK(2);
...
void F893_8772 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x, EIF_TYPED_VALUE arg2x)
{
	GTCX
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 892, Current, 0, 2, 14455);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(892, Current, 14455);
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 892, Current, 0, 2, 14449);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(892, Current, 14449);
	RTCC(arg2, 892, l_feature_name, 2, eif_new_type(217, 0x01), 0x01);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tb1 = !arg1;
...
#define ur1 ur1x.it_r
	...
	RTEAA(l_feature_name, 892, Current, 0, 2, 14450);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(892, Current, 14450);
	RTCC(arg2, 892, l_feature_name, 2, eif_new_type(217, 0x01), 0x01);
	RTIV(Current, RTAL);
	RTHOOK(1);
	if ((EIF_BOOLEAN) !arg1) {
...
#define ur2 ur2x.it_r
	...
	RTEAA(l_feature_name, 892, Current, 0, 2, 14451);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(892, Current, 14451);
...
EIF_TYPED_VALUE F893_8776 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 892, Current, 1, 0, 14453);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
	RTDBGEAA(892, Current, 14453);
	RTIV(Current, RTAL);
	RTHOOK(1);
	tb1 = *(EIF_BOOLEAN *)(Current + RTWA(6676, dtype));
	if (tb1) {
		...
		tp1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(5069, 868))(Current)).it_p);
		up1 = tp1;
