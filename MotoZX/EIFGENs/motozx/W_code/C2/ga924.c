...
extern void F924_9766(EIF_REFERENCE, EIF_TYPED_VALUE);
extern void F924_9767(EIF_REFERENCE, EIF_TYPED_VALUE);
...
extern void F924_9774(EIF_REFERENCE);
extern void F924_10469(EIF_REFERENCE, int);
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 923, Current, 0, 1, 15508);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
body:;
	RTHOOK(2);
	RTDBGAA(Current, dtype, 7610, 0x40000000, 1); /* item */
	*(EIF_POINTER *)(Current + RTWA(7610, dtype)) = (EIF_POINTER) arg1;
	RTHOOK(3);
	RTDBGAA(Current, dtype, 7611, 0x04000000, 1); /* must_free */
	*(EIF_BOOLEAN *)(Current + RTWA(7611, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 0;
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(4);
	RTDBGLE;
...
void F924_9766 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 923, Current, 0, 1, 15509);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
body:;
	...
	*(EIF_POINTER *)(Current + RTWA(7610, dtype)) = (EIF_POINTER) arg1;
	RTHOOK(3);
	RTDBGAA(Current, dtype, 7611, 0x04000000, 1); /* must_free */
	*(EIF_BOOLEAN *)(Current + RTWA(7611, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(4);
	RTDBGLE;
...
void F924_9767 (EIF_REFERENCE Current, EIF_TYPED_VALUE arg1x)
{
	GTCX
...
#define uu4_1 uu4_1x.it_n4
	...
	RTEAA(l_feature_name, 923, Current, 2, 1, 15510);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
body:;
	...
	RTHOOK(7);
	up1 = loc2;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(7606, dtype))(Current, up1x);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(8);
	RTDBGLE;
...
#define up1 up1x.it_p
	...
	RTEAA(l_feature_name, 923, Current, 0, 1, 15511);
	RTSA(dtype);
	RTSC;
	RTME(dtype, 0);
	RTGC;
...
body:;
	...
	up1 = tp1;
	(FUNCTION_CAST(void, (EIF_REFERENCE, EIF_TYPED_VALUE)) RTWF(7607, dtype))(Current, up1x);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(3);
	RTDBGLE;
...
EIF_TYPED_VALUE F924_9769 (EIF_REFERENCE Current)
{
	...
	Result = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(7609, Dtype(Current)))(Current)).it_b);
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(2);
	RTDBGLE;
...
void F924_9770 (EIF_REFERENCE Current)
{
	...
	if ((RTAL & CK_REQUIRE) || RTAC) {
		...
		tb1 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(6530, dtype))(Current)).it_b);
		RTTE(tb1, label_1);
		RTCK;
		RTHOOK(2);
		RTCT("ressource_is_not_open", EX_PRE);
		tb1 = *(EIF_BOOLEAN *)(Current + RTWA(6532, dtype));
...
body:;
	...
	*(EIF_BOOLEAN *)(Current + RTWA(6532, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 1;
	if (RTAL & CK_ENSURE) {
		RTHOOK(4);
		...
		tb2 = *(EIF_BOOLEAN *)(Current + RTWA(6532, dtype));
		if ((!((EIF_BOOLEAN) !tb1) || (tb2))) {
			RTCK;
		} else {
			RTCF;
...
EIF_TYPED_VALUE F924_9771 (EIF_REFERENCE Current)
{
	...
	RTHOOK(1);
	RTDBGAL(Current, 0, 0x04000000, 1,0); /* Result */
	tp1 = *(EIF_POINTER *)(Current + RTWA(7610, Dtype(Current)));
	tb1 = !tp1;
...
EIF_TYPED_VALUE F924_9772 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_POINTER;
	r.it_p = *(EIF_POINTER *)(Current + RTWA(7610,Dtype(Current)));
	return r;
}
...
EIF_TYPED_VALUE F924_9773 (EIF_REFERENCE Current)
{
	EIF_TYPED_VALUE r;
	r.type = SK_BOOL;
	r.it_b = *(EIF_BOOLEAN *)(Current + RTWA(7611,Dtype(Current)));
	return r;
}


/* {GAME_IMAGE}.dispose */
void F924_9774 (EIF_REFERENCE Current)
{
	GTCX
...
#define up1 up1x.it_p
	...
	RTHOOK(1);
	tb1 = '\0';
	tb2 = *(EIF_BOOLEAN *)(Current + RTWA(7611, dtype));
	if (tb2) {
		tb2 = (((FUNCTION_CAST(EIF_TYPED_VALUE, (EIF_REFERENCE)) RTWF(7609, dtype))(Current)).it_b);
		tb1 = tb2;
	}
	if (tb1) {
		RTHOOK(2);
		tp1 = *(EIF_POINTER *)(Current + RTWA(7610, dtype));
		up1 = tp1;
		...
		*(EIF_BOOLEAN *)(Current + RTWA(6532, dtype)) = (EIF_BOOLEAN) (EIF_BOOLEAN) 0;
		...
		RTDBGAA(Current, dtype, 7610, 0x40000000, 1); /* item */
		tp1 = ((EIF_POINTER) 0);
		*(EIF_POINTER *)(Current + RTWA(7610, dtype)) = (EIF_POINTER) tp1;
	}
	RTVI(Current, RTAL);
	RTRS;
	RTHOOK(5);
...
void F924_10469 (EIF_REFERENCE Current, int where)
{
	GTCX
	...
	RTLU (SK_VOID, NULL);
	RTLU (SK_REF, &Current);
	RTEAINV(l_feature_name, 923, Current, 0, 10468);
	RTSA(dtype);
	RTME(dtype, 0);
